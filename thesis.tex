...
%
% 예제
% \documentclass[master,final,oneside]{CNUThesis}
...
%																			%
%                   			             조판은 XeLaTeX로 해야합니다!!							%
%					         승인서는 스캔본 쓰시는것을 권장합니다							%
%																			%
%																			%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


\documentclass[master,oneside,final,krabst]{CNUThesis}
